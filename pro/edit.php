<?Php
	...
	$edit=mysqli_query($conn,"update category set name ='$name', description='$description' where id ='$id'");
...
<body>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
			<?php
					$read=mysqli_query($conn,"select * from category where id='$id'");
			...
			?>
              ...
              <form method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-12">
                    <input type="text" name="description" value="<?php echo $res['name']?>"class="form-control">
                  </div>
                </div>
                <div class="row mb-3 ">
                  <div class="col-sm-10">
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="https://bootstrapmade.com/">Trupti</a>
    </div>
  </footer><!-- End Footer -->
</div>
