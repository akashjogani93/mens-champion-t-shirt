<?php 
	...
	if(isset($_POST['edit'])){
		...
		$update = mysqli_query($conn, "update payment set date = '$date', amount = '$amount' where payment_id = '$payment_id'");
  ...
  <body>
    <div class="container">
		<div class="row">
			<div class="col-md-12">
				<?php
					$read = mysqli_query($conn, "select * from payment where payment_id = '$payment_id'");
