<?php
	...
	if (isset($_REQUEST['user_id'])) {
		...
		// If 'user_id' is not set, redirect or show an error
            ...
            <div class="col-lg-3 col-md-5 d-flex flex-column position-absolute top-50 end-0 translate-middle-y">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">ShopingAdmin</span>
                </a>
              </div><!-- End Logo -->
			...
			?>
                  ...
                  <form class="row g-3 needs-validation" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" id="yourPassword" value="<?php echo $res['password']?>" >
